...
INSERT INTO TEST0 VALUES(1, '상품', 1000, NOW()); 							#SUCCESS
...
INSERT INTO TEST1 VALUES(1, '상품', 1000, NOW()); 							# SUCCESS
...
INSERT INTO TEST2 VALUES(1, '상품', 1000, NOW()); 							# SUCCESS
...
INSERT INTO TEST2(PRODUCT_CD , PRODUCT_NM) VALUES(8 , '상품');				# ERROR
...
INSERT INTO TEST3(PRODUCT_CD , PRODUCT_NM) VALUES(2 , '상품2'); 				# ERROR
INSERT INTO TEST3(PRODUCT_CD , PRODUCT_NM) VALUES(3 , '상품3');				# ERROR
INSERT INTO TEST3 VALUES(4, '상품4' , 4000 , '2022-12-31');

SELECT * FROM TEST3;

# 4) AUTO_INCREMENT : 인덱스 자동증가 ( RPIMARY KEY 속성과 같이 사용한다.)
CREATE TABLE TEST4 (
...
INSERT INTO TEST4(PRODUCT_NM) VALUES('상품11');								# 마지막 CD값 이후부터 1 증가
SELECT * FROM TEST4;
...
CREATE TABLE TEST7_2(
    ...
    CONSTRAINT PRODUCT_CD_REF1 FOREIGN KEY (PRODUCT_CD) REFERENCES TEST7_1(PRODUCT_CD)
);
...
DELETE FROM TEST8_1 WHERE PRODUCT_CD = '3';					# 메인키의 데이터가 수정될 경우 참조키의 데이터는 NULL로 수정
